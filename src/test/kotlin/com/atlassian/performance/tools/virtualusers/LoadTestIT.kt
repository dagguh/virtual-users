...
import com.atlassian.performance.tools.virtualusers.lib.infrastructure.FixedMysqlDatabase
import com.atlassian.performance.tools.virtualusers.lib.infrastructure.FixedOracleJDK
import com.atlassian.performance.tools.virtualusers.lib.infrastructure.FixedPublicJiraSoftwareDistribution
...
class LoadTestIT {
    ...
    private val dataset: Dataset = URI("https://s3-eu-central-1.amazonaws.com/")
        ...
        .let { bucket ->
            Dataset(
                database = FixedMysqlDatabase(MySqlDatabase(
                    HttpDatasetPackage(
    ...
    private fun startJiraNode(
        ...
        SshJiraNode(
            sshHost = jiraSsh,
            jiraDistro = FixedPublicJiraSoftwareDistribution("7.13.0"),
