...
## [Unreleased]
[Unreleased]: https://github.com/atlassian/virtual-users/compare/release-3.11.1...master

### Added
- Expose `VirtualUserTarget.webApplication`, e.g. for early connectivity check.
